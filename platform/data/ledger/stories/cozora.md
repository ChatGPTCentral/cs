# Cozora
- query: `label:Cozora`
- label-id: `Label_2001243660363889001`
- kind: person/org
...
- notes: a real, fast exchange in December (same-day replies both ways), then
  silence after Alex's second message. The other thread on this label is a
  Google Drive share notification, automated, not correspondence

  **month-by-month review, 2026-08-23.** Joel Salinas reached out to Alex on
  Substack before the end of 2025, inviting him into this group. Alex
  joined in early 2026. Cozora is founded by Joel Salinas, Michael Simmons
  and Claudia Faith - the 19 Jan 2026 email thread (`19bd7cbe81a36db6`,
