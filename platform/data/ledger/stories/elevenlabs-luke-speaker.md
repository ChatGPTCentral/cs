...
- last-outbound: none yet - draft created 2026-09-18, message
  `1a0b58d14f0c2250`, new thread (subject "Speaking at our Oct 26 event
  in London?"), not a reply to the July interview thread since the ask
  is unrelated
- next-action: Alex to review and send
- commitments: none
- threads: none yet on this ask. Prior contact: `19f4b92ab426f599`
  (July 2026, AI Central Voices interview invite - Luke politely
  passed, real relationship on file since Cannes/Luma AI event)
- notes: Sixth speaker invite for the Oct 26 event, alongside Nuria
  (Canva), Carola Dixon and Jason Day (Luma), Fiona Turko (Gamma,
  routing ask) and Jake MccGwire (beehiiv) - see
  [[canva-nuria-speaker]], [[luma-carola-speaker]],
  [[luma-jasonday-speaker]], [[gamma-fiona-speaker]] and
  [[beehiiv-jake-speaker]].
