...
- people: Hod (`hod@guidde.co`), Yoav (`yoav@guidde.co`, cc on later
  ...
  touch)
- status: **yours** - chasing, no reply seen in any thread read
- last-inbound: none found - every message in both threads is from Alex or
  Sam (sam@theaicentral.net)
- last-outbound: 2026-05-11 (alex@thecentral.ai, "just bumping this up in
  case it got lost")
- idle: 100 days
- next-action: none unless reviving - this has been chased six times
  (3 Mar, 16 Feb, 19 Feb, 25 Feb, 2 Mar, 10 Mar from Sam; 24 Mar, 1 Apr, 7 Apr,
  6 May, 11 May from Alex) with no visible reply from Hod in the window read
