...
from deck_shared import ACCENT, SURFACE, GRID, INK, MUTED, FOOT, make_renumber, bars_svg, stat, case
...
renumber = make_renumber("CASE STUDIES 2026")
...
<section class="slide light" data-label="Run yours" data-notes="Replit is the one remaining candidate without a campaign report; the playbook states 200+ signups for the iOS-apps carousel. Same template, drop-in once a report exists.">
  ...
  <div data-step="2" style="margin-top:22px;font-size:18px;font-weight:300;color:var(--muted)">Every campaign closes with a written report in the same format as the five pages before this one: clicks, downloads, and cost against a stated benchmark</div>
