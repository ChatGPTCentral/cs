...
<section class="slide light" data-label="The publications"
  ...
  8 Sep 2026, per Alex (fourth follow-up, this slide ONLY - slide 7's matching channel names are untouched): didn't like how the card-1/card-2 links rendered, so simplified all three titles and sub-lines. Card 1: title drops '(thecentral.ai)' to just 'AI Central Newsletter'; sub-line drops the '/subscribe' path, now links to thecentral.ai itself. Card 2: title drops '(LinkedIn)' to 'AI Central Newsletter' too (now identical to card 1's title - the logo and stats still tell them apart); sub-line reworded 'AI Central, on LinkedIn' -> 'AI Central on LinkedIn' (comma dropped) and repointed from the newsletter's own LinkedIn URL to the LinkedIn company page (linkedin.com/company/chat-gpt-central). Card 3: title drops '(LinkedIn)' to 'Social Media'; sub-line was plain text (the bare URL) - now the same 'AI Central on LinkedIn' link text as card 2, pointing at the same company-page URL, per Alex's explicit instruction.
  8 Sep 2026, per Alex (fifth follow-up): card 4's sub-line ('thecentral.ai') was still plain text, inconsistent with card 1's now-clickable link - made it a real link to thecentral.ai too, same style as the other three. Separately (this one also touches slide 7, per Alex's explicit ask this round): CH_BEEHIIV/CH_LI_NEWS/CH_LI_PAGE below - which drive slide 7's 'Available on' tags - renamed to match this slide's now-simplified card titles ('AI Central Newsletter (thecentral.ai)' -> 'AI Central Newsletter', 'AI Central Newsletter (LinkedIn)' -> 'AI Central Newsletter', 'Social Media (LinkedIn)' -> 'Social Media'); CH_WEBSITE was already just 'Website', unchanged.">
  ...
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:18px;margin-top:34px">
    {pub(1, A['logo_aicentral_square'], "AI Central Newsletter", '<a href="https://thecentral.ai" target="_blank" rel="noopener" style="color:inherit;text-decoration:underline">thecentral.ai</a>', "mobile-first offers: downloads, webinar signups", [
      ("Active subscribers", "97K+"), ("New subscribers a month", "+4,900"),
      ("Average open rate", "30%"), ("Average unique CTR", "2.3%"), ("Posts a week", "4x")])}
    {pub(2, A['logo_linkedin'], "AI Central Newsletter", '<a href="https://linkedin.com/company/chat-gpt-central" target="_blank" rel="noopener" style="color:inherit;text-decoration:underline">AI Central on LinkedIn</a>', "desktop-first offers: demos, extensions, announcements", [
      ("Active subscribers", "181K+"), ("New subscribers a month", "+5,500"),
      ("Average unique CTR", "2.7%"), ("Posts a week", "4x")])}
    {pub(3, A['logo_linkedin'], "Social Media", '<a href="https://linkedin.com/company/chat-gpt-central" target="_blank" rel="noopener" style="color:inherit;text-decoration:underline">AI Central on LinkedIn</a>', "sustained brand visibility and thought leadership, not single placements", [
      ("Active followers", "289K"), ("New followers a month", "+8,300"),
      ("Average impressions per post", "4,500+"), ("Posts a week", "Daily")])}
    {pub(4, A['logo_aicentral_square'], "Website", '<a href="https://thecentral.ai" target="_blank" rel="noopener" style="color:inherit;text-decoration:underline">thecentral.ai</a>', "continuous presence between and beyond campaigns", [
...
CH_BEEHIIV = [(A['logo_aicentral_square'], "AI Central Newsletter")]
CH_LI_NEWS = [(A['logo_linkedin'], "AI Central Newsletter")]
CH_LI_PAGE = [(A['logo_linkedin'], "Social Media")]
...
# Rate card slide REMOVED from here, 9 Sep 2026 per Alex - moved to its own
# standalone "Pricing" presentation instead (cover + pricing breakdown + case
# studies extended, alongside the investor/financial deck and this media kit
# as the third preso in the set). The table content/copy carries over
# unchanged into that deck's own build script - see decks/pricing/.
