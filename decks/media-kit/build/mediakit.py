...
def renumber(sec, n):
    ...
    sec = sec.replace('<div class="foot">AI CENTRAL</div>',
                      f'<div class="foot">AI CENTRAL &nbsp;·&nbsp; MEDIA KIT Q3 2026 &nbsp;·&nbsp; {n:02d}</div>')
    return sec.rstrip()
  ...
  <div style="display:grid;grid-template-columns:560px 1fr;gap:56px;margin-top:14px;align-items:start">
    ...
    <div data-step="3">
      ...
      <div style="display:flex;gap:18px;margin-top:8px;font-size:17px;color:var(--muted);flex-wrap:wrap">
        <span><i style="display:inline-block;width:12px;height:12px;border-radius:2px;background:#A50D26;vertical-align:-1px"></i> North America 50%</span>
        <span><i style="display:inline-block;width:12px;height:12px;border-radius:2px;background:#D9636F;vertical-align:-1px"></i> Europe 13% + UK 6%</span>
        <span><i style="display:inline-block;width:12px;height:12px;border-radius:2px;background:#CE4B59;vertical-align:-1px"></i> Asia 14%</span>
...
<section class="slide light" data-label="LinkedIn Carousel"
  ...
  <div style="display:grid;grid-template-columns:1fr 1.25fr;gap:44px;margin-top:24px;align-items:start">
    <div data-step="1">
      ...
      <img src="{A['carousels']}" alt="Carousel examples for Gamma, ElevenLabs, Canva, Guidde and Comet" style="width:100%;margin-top:16px;border-radius:6px">
    </div>
    <div data-step="2">
      {label("Packages")}
      <div style="margin-top:8px">{price_table([
        ("1 carousel", "$699", "-"),
        ("3 carousels", "$1,999", "5% off"),
        ("5 carousels", "$2,999", "15% off"),
        ("1 carousel + 1 LinkedIn Main Ad", "$999", "20,000 impressions, 200 PDF downloads"),
        ("3 carousels + 3 LinkedIn Main Ads", "$2,799", "60,000 impressions, 600 PDF downloads"),
...
<section class="slide light" data-label="LinkedIn Main Ad"
  ...
  <div style="display:grid;grid-template-columns:1.25fr 1fr 360px;gap:36px;margin-top:24px;align-items:start">
    <div data-step="1">
      {label("Packages")}
      <div style="margin-top:8px">{price_table([
        ("1 Main Ad", "$899", "20,000 impressions, 100 unique clicks"),
        ("2 Main Ads", "$1,750", "40,000 impressions, 200 unique clicks"),
        ("3 Main Ads", "$2,499", "60,000 impressions, 300 unique clicks"),
        ("4 Main Ads", "$3,200", "80,000 impressions, 400 unique clicks"),
        ("5 Main Ads", "$3,799", "100,000 impressions, 500 unique clicks"),
      ], ["Package", "Price", "Minimum results"], ["30%", "20%", "50%"])}</div>
      <div style="margin-top:12px;font-size:17px;font-weight:300;color:var(--muted)">Max CPM from $44.95 down to $37.99. Max CPC from $8.90 down to $7.50. Add a carousel to any package for $100 to $700 more</div>
    </div>
    <div data-step="2">
      {label("What you receive")}
      <div style="margin-top:8px">{bullets([
...
<section class="slide light" data-label="Email newsletter ads"
  ...
  <p class="subline">Three placements in every issue. Sent to 97K+ subscribers and published on thecentral.ai</p>
  <div style="display:grid;grid-template-columns:1.2fr 1fr 300px;gap:36px;margin-top:24px;align-items:start">
    <div data-step="1">
      {label("Primary Ad packages")}
      <div style="margin-top:8px">{price_table([
        ("1 Primary Ad", "$1,299", "30,000 impressions, 200 clicks"),
        ("2 Primary Ads", "$2,499", "60,000 impressions, 400 clicks"),
        ("3 Primary Ads", "$3,699", "90,000 impressions, 600 clicks"),
        ("4 Primary Ads", "$4,599", "120,000 impressions, 800 clicks"),
        ("5 Primary Ads", "$5,499", "150,000 impressions, 1,000 clicks"),
      ], ["Package", "Price", "Minimum results"], ["30%", "20%", "50%"])}</div>
      <div style="margin-top:12px;font-size:17px;font-weight:300;color:var(--muted)">Max CPM from $43.30 down to $36.60. Max CPC from $6.40 down to $5.40. Full look-through analytics of openers and clickers, for retargeting</div>
    </div>
    <div data-step="2">
      {label("The three placements")}
      <div style="margin-top:8px">
        ...
        <div style="padding:10px 0;border-top:1px solid rgba(0,0,0,.08)"><div style="display:flex;justify-content:space-between;align-items:baseline"><b style="font-size:21px">Tools Ad</b><span style="font-size:19px;font-weight:700;color:var(--accent)">20 to 50 clicks an issue</span></div><div style="font-size:17px;font-weight:300;line-height:1.35;color:#3A3A3A;margin-top:3px">In our Favourite Tools section, next to tools readers already trust. Logo plus a 25-word line. Max four per issue</div></div>
      </div>
    </div>
    <div data-step="2" style="text-align:center">
...
<section class="slide light" data-label="How it works"
  ...
  <div data-step="2" style="margin-top:26px;background:var(--ink);color:var(--paper);padding:28px 36px;display:flex;gap:40px;align-items:center">
    ...
    <div style="font-size:22px;font-weight:300;line-height:1.45;color:#D9D6D1">Every bundle has agreed targets for impressions, clicks or downloads. If the first run does not reach them, we keep publishing supporting placements at no extra cost until it does</div>
  </div>
  <div data-step="3" style="margin-top:22px;display:flex;gap:40px;font-size:21px;font-weight:300;color:var(--muted)">
    <div><b style="color:var(--ink)">10% off</b> for new clients</div>
    <div><b style="color:var(--ink)">10% off</b> new main ad orders for carousel clients</div>
    <div><b style="color:var(--ink)">Custom bundles</b> combine carousels, main ads, dedicated issues and interviews</div>
  </div>
  {FOOT}
</section>'''
